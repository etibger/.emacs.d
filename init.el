...
(global-set-key (kbd "C-x M-p") 'ace-window)
...
;; save current window configuration to buffer w
(fset 'window-configuration-to-register-w [?\C-x ?r ?w ?w])
(global-set-key (kbd "C-<f6>") 'window-configuration-to-register-w)

;; restore saved  window configuration from buffer w
(fset 'window-configuration-from-register-w [?\C-x ?r ?j ?w])
(global-set-key (kbd "<f6>") 'window-configuration-from-register-w)
